...
public class MenuPausa {
    ...
    // 2. Remover menú de pausa primero
    System.out.println("  - Removiendo menú de pausa del GuiNode");
    if (menuPausaNode != null && menuPausaNode.getParent() != null) {
        menuPausaNode.removeFromParent();
    }
    
    // 3. ⭐ CRÍTICO: Limpiar el menú de pausa completamente
    limpiar();
    
    System.out.println("  - Estado pausado después: " + pausado);
    
    // 4. Ejecutar callback (esto debería limpiar el GameplayAppState)
